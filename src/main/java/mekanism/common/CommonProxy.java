...
public class CommonProxy implements IGuiProvider {
    ...
    /**
     * Handles a PERSONAL_CHEST_CLIENT_OPEN packet via the proxy, not handled on the server-side.
    ...
    public void loadConfiguration() {
        ...
        general.TO_IC2 = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "EUToJoules", 0.1D).getDouble();
