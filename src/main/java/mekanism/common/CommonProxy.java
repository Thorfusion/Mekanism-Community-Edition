...
public class CommonProxy implements IGuiProvider
{
	...
	public void loadConfiguration()
	{
		...
		mekce.enabledeepslateosmium = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "DeepslateOsmiumPerChunk", true, "adds deepslate osmium ore if et futurum requiem is present").getBoolean();
