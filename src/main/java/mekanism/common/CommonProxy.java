...
public class CommonProxy implements IGuiProvider
{
	...
	public void loadConfiguration()
	{
		...
		mekce.disableUniversalCableServerVisualUpdates = Mekanism.configurationce.get("mekce", "disableUniversalCableServerVisualUpdates", true, "Enabled by default. Disables server-side Universal Cable visual energy updates to reduce server tick overhead from cable render sync. Energy transfer logic is unchanged. Clients render Universal Cables as full while this is enabled.").getBoolean();
