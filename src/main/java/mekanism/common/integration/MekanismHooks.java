...
public final class MekanismHooks
{
	...
	public void hookIC2Recipes()
	{
		...
		try {
			Recipes.macerator.addRecipe(new RecipeInputOreDict("orePlatinum"), null, new ItemStack(MekanismItems.Dust, 2, Resource.PLATINUM.ordinal()));
		} catch(Exception e) {}

		try {
			Recipes.macerator.addRecipe(new RecipeInputOreDict("ingotPlatinum"), null, new ItemStack(MekanismItems.Dust, 1, Resource.PLATINUM.ordinal()));
