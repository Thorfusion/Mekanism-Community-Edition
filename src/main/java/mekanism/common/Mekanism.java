...
public class Mekanism {
    ...
    private void registerTileEntities() {
        ...
        registerTileEntity(TileEntityUltimateFactory.class, "elite_smelting_factory");//Because it was registered as a ultimate_smelting_factory by the original Elite Factory, it was registered as a elite_smelting_factory
