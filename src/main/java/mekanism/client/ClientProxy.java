...
public class ClientProxy extends CommonProxy
{
	...
	public void loadConfiguration()
	{
		...
		mekce_client.dynamicTransmitterRenderDistance = Mekanism.configurationce.get("mekce_client", "dynamicTransmitterRenderDistance", 32, "Maximum block distance for rendering dynamic transmitter contents when distance culling is enabled. Default is 48.", 1, 512).getInt();
