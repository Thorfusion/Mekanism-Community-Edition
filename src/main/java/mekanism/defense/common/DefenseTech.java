...
@Mod(modid = Reference.NAME, name = Reference.NAME, version = "GRADLE_MODVERSION", guiFactory = "defense.client.gui.ConfigGuiFactory", dependencies = "required-after:Mekanism")
public final class DefenseTech
{
    ...
    public void postInit(FMLPostInitializationEvent event)
    {
        ...
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherBase(BaseTier.BASIC), new Object[] { "S S", "SCS", "SIS", 'S', "ingotSteel", 'C', "circuitBasic", 'I', new ItemStack(MekanismBlocks.BasicBlock, 1, 8) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherBase(BaseTier.ADVANCED), new Object[] { "SAS", "CBC", "SSS", 'S', "ingotSteel", 'A', "alloyAdvanced", 'C', "circuitAdvanced", 'B', DefenseUtils.getLauncherBase(BaseTier.BASIC) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherBase(BaseTier.ELITE), new Object[] { "SAS", "CBC", "SSS", 'S', "ingotSteel", 'A', "alloyElite", 'C', "circuitElite", 'B', DefenseUtils.getLauncherBase(BaseTier.ADVANCED) }));
        // Missile Launcher Panel
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherScreen(BaseTier.BASIC), new Object[] { "SGS", "CIC", "STS", 'S', "ingotSteel", 'G', "blockGlass", 'C', "circuitBasic", 'I', new ItemStack(MekanismBlocks.BasicBlock, 1, 8), 'T', new ItemStack(MekanismItems.PartTransmitter, 1, 0) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherScreen(BaseTier.ADVANCED), new Object[] { "SGS", "CIC", "STS", 'S', "ingotSteel", 'G', "blockGlass", 'C', "circuitAdvanced", 'I', DefenseUtils.getLauncherScreen(BaseTier.BASIC), 'T', "alloyAdvanced" }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherScreen(BaseTier.ELITE), new Object[] { "SAS", "CDC", "STS", 'S', "ingotSteel", 'A', "alloyElite", 'C', "circuitElite", 'D', new ItemStack(MekanismBlocks.BasicBlock2, 1, 9), 'T', DefenseUtils.getLauncherScreen(BaseTier.ADVANCED) }));
        // Missile Launcher Support Frame
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherFrame(BaseTier.BASIC), new Object[] { "S S", "SCS", "S S", 'S', "ingotSteel", 'C', new ItemStack(MekanismBlocks.BasicBlock, 1, 8) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherFrame(BaseTier.ADVANCED), new Object[] { "SAS", "SFS", "SAS", 'S', "ingotSteel", 'A', "alloyAdvanced", 'F', DefenseUtils.getLauncherFrame(BaseTier.BASIC) }));
        CraftingManager.getInstance().getRecipeList().add(new ShapedMekanismRecipe(DefenseUtils.getLauncherFrame(BaseTier.ELITE), new Object[] { "SAS", "SFS", "SAS", 'S', "ingotSteel", 'A', "alloyElite", 'F', DefenseUtils.getLauncherFrame(BaseTier.ADVANCED) }));
        // Radar Station
