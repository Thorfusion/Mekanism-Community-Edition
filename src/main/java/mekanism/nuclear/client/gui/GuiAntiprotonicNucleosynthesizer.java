...
public class GuiAntiprotonicNucleosynthesizer
      extends GuiMekanismTile<TileEntityAntiprotonicNucleosynthesizer> {

    public GuiAntiprotonicNucleosynthesizer(InventoryPlayer inventory,
        ...
        addGuiElement(new GuiSlot(SlotType.INPUT, this, resource, 46, 34));
        addGuiElement(new GuiSlot(SlotType.OUTPUT, this, resource, 132, 34));
        addGuiElement(new GuiSlot(SlotType.NORMAL, this, resource, 154, 55).with(SlotOverlay.POWER));
        addGuiElement(new GuiProgress(new GuiProgress.IProgressInfoHandler() {
            @Override
            public double getProgress() {
                return tileEntity.getScaledProgress();
            }
        }, ProgressBar.LARGE_RIGHT, this, resource, 74, 39));
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRenderer.drawString(LangUtils.localize("gui.AntiprotonicNucleosynthesizer.short"), 45, 4, 0x404040);
